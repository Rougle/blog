(defproject blogger "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot blogger.core

  :repl-options {:host "0.0.0.0" :port 7000}
                  ...
                  :cljsbuild{:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "blogger.core/mount-components"}
                     :compiler
                     {:main "blogger.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
